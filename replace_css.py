...
if start != -1 and end != -1:
    ...
    div[data-testid="stVerticalBlockBorderWrapper"] {
        ...
        padding: 2.5rem !important; transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275) !important;
    }
    div[data-testid="stVerticalBlockBorderWrapper"]:hover { 
        border-color: rgba(167, 139, 250, 0.3) !important; transform: translateY(-5px) !important;
        box-shadow: 0 30px 60px rgba(0,0,0,0.6), 0 0 20px rgba(139, 92, 246, 0.1), inset 0 1px 0 rgba(255,255,255,0.1) !important;
    }
    
    .stButton button { 
        border-radius: 50px !important; font-weight: 600 !important; font-size: 0.95rem !important; 
        padding: 0.7rem 2rem !important; transition: all 0.3s ease !important;
    ...
    .stButton button[kind="primary"]:hover { 
        ...
        box-shadow: 0 8px 25px rgba(109, 40, 217, 0.6), inset 0 1px 0 rgba(255,255,255,0.3) !important;
    ...
    .stButton button[kind="secondary"]:hover { 
        ...
        border-color: rgba(255, 255, 255, 0.2) !important; transform: translateY(-2px) !important;
    ...
    .stRadio label:hover { 
        ...
        transform: translateX(4px); box-shadow: 0 6px 12px rgba(0,0,0,0.2);
    }
...
# Replace create_dark_metric
metric_start = text.find('def create_dark_metric')
import re
if metric_start != -1:
    old_func_pattern = r'def create_dark_metric\(label, value, icon, bg_color, icon_color\):.*?return f\"\"\".*?</div>\s*\"\"\"'
    new_metrics = '''def create_dark_metric(label, value, icon, bg_color, icon_color):
    ...
    \"\"\"'''
    text = re.sub(old_func_pattern, new_metrics, text, flags=re.DOTALL)
